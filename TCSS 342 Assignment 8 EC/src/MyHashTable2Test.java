...
public class MyHashTable2Test
{
	...
	{
		hashtable = new MyHashTable<Integer, Integer>(32768, true);
	}
	...
	public final void put_5()
	{
		...
		assertEquals(4, hashtable.comparisons, "put_5 failed");
	...
	public final void put_6()
	{
		...
		hashtable.put(1, 11);
		hashtable.put(32768, 10);
		assertEquals("[0:10, 32768:10, 1:11]", hashtable.toString(), "put_6 failed");
		assertEquals(3, hashtable.size(), "put_6 failed");
		assertEquals(4, hashtable.comparisons, "put_6 failed");
		assertEquals(2, hashtable.maxProbe, "put_6 failed");
	}
	...
	public final void put_7()
	{
		...
		hashtable.put(2, 12);
		hashtable.put(32768, 10);
		assertEquals("[0:10, 32768:10, 1:11, 2:12]", hashtable.toString(), "put_7 failed");
		assertEquals(4, hashtable.size(), "put_7 failed");
		assertEquals(5, hashtable.comparisons, "put_7 failed");
		assertEquals(2, hashtable.maxProbe, "put_7 failed");
	}
	...
	public final void put_8()
	{
		...
		hashtable.put(32768, 10);
		hashtable.put(2, 12);
		assertEquals("[0:10, 32768:10, 1:11, 2:12]", hashtable.toString(), "put_8 failed");
		assertEquals(4, hashtable.size(), "put_8 failed");
		assertEquals(5, hashtable.comparisons, "put_8 failed");
		assertEquals(2, hashtable.maxProbe, "put_8 failed");
	}
	...
	public final void put_u()
	{
		...
		assertEquals(10, hashtable.size(), "put_u failed");
		assertEquals(30, hashtable.comparisons, "put_u failed");
		assertEquals(2, hashtable.maxProbe, "put_u failed");
	}
	...
	public final void get_3()
	{
		...
		assertEquals(4, hashtable.comparisons, "get_3 failed");
		assertEquals(2, hashtable.maxProbe, "get_3 failed");
	}
	...
	public final void unique_words()
	{
		...
		assertEquals(20228, un.chainHashOfUniqueWords.size(), "unique_words failed");
		assertEquals(26554, un.chainHashOfUniqueWords.comparisons, "unique_words failed");
		assertEquals(6, un.chainHashOfUniqueWords.maxProbe, "unique_words failed");
	}
