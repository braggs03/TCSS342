...
public final class BookReader {
    ...
    /** Stores all words from the parsed txt document. */
    public final MyLinkedList<String> wordsAndSeparators;
     ...
     */
    private void readBook(final String theFileName) {
        ...
        for (int i = 0; i < book.length(); i++) {
            ...
            if (character.compareTo('A') >= 0 && character.compareTo('Z') <= 0
                ...
                if (!builder.isEmpty()) {
                    ...
                    wordsAndSeparators.addBefore(builder.toString());
                }
                wordsAndSeparators.addBefore(String.valueOf(character));
                builder.setLength(0);
            }
        }
    }
