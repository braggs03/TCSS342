...
public class MyOrderedList<T extends Comparable<T>> {
    ...
    /**
     * Returns the item at the give index, null if no value is present.
     * @param theIndex The index of value to be returned.
     * @return Returns the element at the position of the index.
     */
